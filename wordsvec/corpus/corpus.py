...
def ingest(target_file, output_directory, cleaning_pipeline, tokenization_pipeline):
    # read file:
...
def generate_corpus(input_directory, output_directory):
